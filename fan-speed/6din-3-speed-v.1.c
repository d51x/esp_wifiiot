...
/*
Options:
Local Control, Fan Speed 0-3
---
LocalControl: 1 = enable local control: speed, present flag and pwm
...
#define LOCAL_CONTROL_CFG   SENSCFG[0] // LocalControl
#define FAN_SPEED_CFG       SENSCFG[1] // fan speed

#define LOCAL_CONTROL   valdes[0] // local control

#define FAN_SPEED_VALDES_IDX 1
#define FAN_SPEED       valdes[1] // fan speed

#define PRESENT_FLAG    valdes[2] // present flag
