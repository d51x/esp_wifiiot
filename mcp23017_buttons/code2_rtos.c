...
void startfunc(){
    ...
    mcp23017_isr_handler_add( 0, GPIO_INTR_POSEDGE, mcp23017_button_isr_cb, 208, mcp23017_button_isr_cb, 209, 1000);
    mcp23017_isr_handler_add( 1, GPIO_INTR_NEGEDGE, mcp23017_button_isr_cb, 209, NULL, NULL, 0);
    mcp23017_isr_handler_add( 2, GPIO_INTR_NEGEDGE, mcp23017_button_isr_cb, 210, NULL, NULL, 0);
    mcp23017_isr_handler_add( 3, GPIO_INTR_ANYEDGE, mcp23017_button_isr_cb, 211, NULL, NULL, 0);
