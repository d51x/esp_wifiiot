...
#if termoe
#define THERMO_STATE		sensors_param.thermo[THERM_NUMBER-1][0]
#define THERMO_HYSTERESIS	sensors_param.thermzn[THERM_NUMBER-1][1]//-sensors_param.thermzn[THERM_NUMBER-1][0]
#define THERMO_SETPOINT 	sensors_param.thermzn[THERM_NUMBER-1][0]
#else
